...
LevelSelectLayer2::LevelSelectLayer2()  
{  
}  
...
{  
    ...
    do {  
        ...
        Sprite* sprite =Sprite::create("selectLevelBg2.png");  
		...
		for ( int row = 0; row < LEVEL_COL; row++ )
		{
			...
			for ( int col = 0; col < LEVEL_ROW; col++)
			{
				...
				auto item = MenuItemImage::create(  
                                           ...
                                           "card_2.png",
										   "card_3.png",
                                           CC_CALLBACK_1(LevelSelectLayer2::menuCloseCallback0, this)); 
...
void LevelSelectLayer2::menuCloseCallback0(Ref* pSender)
{  
