...
void LoadingResScene::addBackGround()
{
   //ÃÌº”±≥æ∞∫Õlogoµ»
...
{
	Director::getInstance()->replaceScene(CCTransitionFade::create(0.1f, UIScene::createScene()));
}
...
void LoadingResScene::loadResources()
{
	...
	Director::getInstance()->getTextureCache()->addImageAsync("failedBg.jpg", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	Director::getInstance()->getTextureCache()->addImageAsync("playbg.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	Director::getInstance()->getTextureCache()->addImageAsync("selectBg.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	Director::getInstance()->getTextureCache()->addImageAsync("selectLevelBg.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	Director::getInstance()->getTextureCache()->addImageAsync("failedPanel.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
    Director::getInstance()->getTextureCache()->addImageAsync("successfulBg.jpg", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
    Director::getInstance()->getTextureCache()->addImageAsync("title.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	...
	Director::getInstance()->getTextureCache()->addImageAsync("btnBack.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	Director::getInstance()->getTextureCache()->addImageAsync("btnNext.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	Director::getInstance()->getTextureCache()->addImageAsync("btnStart.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	...
	Director::getInstance()->getTextureCache()->addImageAsync("main.jpg", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	Director::getInstance()->getTextureCache()->addImageAsync("selectHouse.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
	...
	Director::getInstance()->getTextureCache()->addImageAsync("selectLevelBg3.png", CC_CALLBACK_1(LoadingResScene::loadingCallBack, this));
