...
LevelSelectLayer1::LevelSelectLayer1()  
{  
}  
...
{  
    ...
    do {  
        ...
        Sprite* sprite =Sprite::create("selectLevelBg.png");  
		...
		for ( int row = 0; row < LEVEL_COL; row++ )
		{
			...
			for ( int col = 0; col < LEVEL_ROW; col++)
			{
				...
				auto item = MenuItemImage::create(  
                                           ...
                                           "card_2.png",
										   "card_3.png",
                                           CC_CALLBACK_1(LevelSelectLayer1::menuCloseCallback0, this)); 
		...
		//this->getChildByTag(0)->setEnabled(false);
...
void LevelSelectLayer1::menuCloseCallback0(Ref* pSender)
{  
